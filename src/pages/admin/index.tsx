        ...
        <div className="flex items-center flex-col min-h-screen pb-7 px-2">
            ...
            <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
                ...
                <section className="flex my-4 gap-5">
                    ...
                    onChange={
                        (e)=> setTextColorInput(e.target.value)
                    ...
                    onChange={
                        (e)=> setBackgroundColorInput(e.target.value)
              ...
              {links.map((link)=> (
                  ...
                  style={{backgroundColor: link.bg, color: link.color}}>
                      <Link to={link.url} target="_blank"><p>{link.name}</p></Link>
                      <div>
                          <button onClick={()=> handleDeleteLink(link.id)} className="border border-dashed p-1 rounded"><FiTrash size={18} color="#FFF"/></button>
                      </div>
                  </article>
              ))}
